...
// Variables
const rootDomain = "orcha.my.id"; // Ganti dengan domain utama kalian
const serviceName = "cova"; // Ganti dengan nama workers kalian
...
const KV_PROXY_URL = "https://raw.githubusercontent.com/787810/cova/refs/heads/main/kvProxyList.json";
const PROXY_BANK_URL = "https://raw.githubusercontent.com/787810/cova/refs/heads/main/proxyList.txt";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>cova</span>");
